...
import hjapp.com.hjclass_mobile.d.n;
...
public final class b
{
  ...
  public static u a(String paramString1, String paramString2)
  {
    try
    {
      ...
      hjapp.com.hjclass_mobile.h.u.b("url=http://class.swfplayer.net/api/mobile/getuserhome.php?token=" + paramString1 + "&v=4");
    ...
    {
      hjapp.com.hjclass_mobile.h.u.a("Download Resource Task", localException.getMessage());
    }
    return null;
  }
  ...
  public static List b(String paramString1, String paramString2)
  {
    try
    {
      ...
      hjapp.com.hjclass_mobile.h.u.c("==url", "http://hxjiang.duapp.com/api/mobile/mobile_card.ashx?action=6nu19l&token=" + paramString2 + "&card=" + paramString1 + "&v=4");
      HttpURLConnection localHttpURLConnection = a(localURL);
      String str = new String(a(localHttpURLConnection.getInputStream()));
      localHttpURLConnection.disconnect();
      if (TextUtils.isEmpty(str))
        return null;
      hjapp.com.hjclass_mobile.h.u.d("学习卡获取的返回JSON为：", str);
      ...
      if (Integer.parseInt(localJSONObject1.getString("code")) == 0)
      {
        ...
        hjapp.com.hjclass_mobile.h.u.d("学习卡返回的错误信息：", localw1.j());
  ...
  public static JSONObject b(String paramString1, String paramString2, String paramString3)
  {
    ...
    hjapp.com.hjclass_mobile.h.u.a("学习卡开课请求的详细数据：", str);
    return f(str);
  }
  ...
  public static JSONObject b(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    hjapp.com.hjclass_mobile.h.u.c("====", str);
    return f(str);
  }
  ...
  private static JSONObject f(String paramString)
  {
    try
    {
      ...
      hjapp.com.hjclass_mobile.h.u.a("jsonString=", str);
      if (TextUtils.isEmpty(str))
        return null;
  ...
  public final List a(String paramString, int paramInt1, int paramInt2)
  {
    try
    {
      ...
      for (int j = 0; j < i; j++)
      {
        ...
        localn.m(hjapp.com.hjclass_mobile.h.z.c(String.valueOf(localn.h())));
        localn.n(localn.d());
