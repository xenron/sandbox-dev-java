...
public final class f
{
  ...
  private e g = null;
  private hjapp.com.hjclass_mobile.d.o h = null;
  private File i = null;
  private long j = 0L;
  ...
  public final void a(hjapp.com.hjclass_mobile.d.o paramo, e parame)
  {
    this.h = paramo;
    this.g = parame;
    ...
    if (this.i.exists())
    {
      ...
      paramo.b(i1);
      hjapp.com.hjclass_mobile.h.u.b("上次文件下载文件大小" + paramo.a());
      hjapp.com.hjclass_mobile.h.u.b("文件总大小" + paramo.b());
    }
    while (true)
    {
