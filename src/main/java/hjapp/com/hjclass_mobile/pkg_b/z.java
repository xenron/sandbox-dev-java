...
import hjapp.com.hjclass_mobile.pkg_d.ae;
import hjapp.com.hjclass_mobile.pkg_d.b;
import hjapp.com.hjclass_mobile.pkg_d.c;
import hjapp.com.hjclass_mobile.pkg_d.d;
import hjapp.com.hjclass_mobile.pkg_d.e;
import hjapp.com.hjclass_mobile.pkg_d.f;
import hjapp.com.hjclass_mobile.pkg_d.g;
import hjapp.com.hjclass_mobile.pkg_d.h;
import hjapp.com.hjclass_mobile.pkg_d.j;
...
public final class z
{
  ...
  private static List a(Document paramDocument)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      localy.b(Integer.valueOf(hjapp.com.hjclass_mobile.pkg_h.z.a(localElement2.attributeValue("timeStamp"))));
  ...
  private static List a(Element paramElement)
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      {
        hjapp.com.hjclass_mobile.pkg_d.i locali = new hjapp.com.hjclass_mobile.pkg_d.i();
      ...
      while (true)
      {
        ...
        if (locall.a().endsWith("pic"))
        {
          ...
          locald.f(hjapp.com.hjclass_mobile.pkg_h.z.a(b(localElement, "endEffTime")));
          locald.a(b(localElement, "startEffName"));
          locald.e(hjapp.com.hjclass_mobile.pkg_h.z.a(b(localElement, "startEffTime")));
        ...
        {
          hjapp.com.hjclass_mobile.pkg_d.j localj = new j();
          ...
          localj.f(hjapp.com.hjclass_mobile.pkg_h.z.a(b(localElement, "endEffTime")));
          localj.b(b(localElement, "startEffName"));
          localj.e(hjapp.com.hjclass_mobile.pkg_h.z.a(b(localElement, "startEffTime")));
        ...
        else if (locall.a().endsWith("timer"))
        {
          ...
          localk.c(hjapp.com.hjclass_mobile.pkg_h.z.a(b(localElement, "delay")));
          localk.d(hjapp.com.hjclass_mobile.pkg_h.z.a(b(localElement, "stop")));
          locall.a(localk);
        }
        ...
        {
          hjapp.com.hjclass_mobile.pkg_d.m localm = new m();
          ...
          localm.f(hjapp.com.hjclass_mobile.pkg_h.z.a(b(localElement, "endEffTime")));
          localm.a(b(localElement, "startEffName"));
          localm.e(hjapp.com.hjclass_mobile.pkg_h.z.a(b(localElement, "startEffTime")));
        ...
        else
        {
          if (locall.a().endsWith("audio"))
          {
            ...
            localc.d(hjapp.com.hjclass_mobile.pkg_h.z.a(b(localElement, "endEffTime")));
            localc.b(b(localElement, "startEffName"));
            localc.c(hjapp.com.hjclass_mobile.pkg_h.z.a(b(localElement, "startEffTime")));
          ...
          if (locall.a().endsWith("video"))
          {
            ...
            locale.d(hjapp.com.hjclass_mobile.pkg_h.z.a(b(localElement, "endEffTime")));
            locale.b(b(localElement, "startEffName"));
            locale.c(hjapp.com.hjclass_mobile.pkg_h.z.a(b(localElement, "startEffTime")));
          ...
          {
            hjapp.com.hjclass_mobile.pkg_d.h localh = new h();
  ...
  private static ad b(Element paramElement)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((str4.equals("questionTxtArea")) || (str4.equals("questionTxt")))
        ...
        str3 = str3 + hjapp.com.hjclass_mobile.pkg_h.z.d(localElement.elementTextTrim("content")) + "|";
  ...
  private static String b(Element paramElement, String paramString)
  {
    String str = paramElement.attributeValue(paramString);
    if (str != null)
      return hjapp.com.hjclass_mobile.pkg_h.y.b(str);
    return null;
  }
