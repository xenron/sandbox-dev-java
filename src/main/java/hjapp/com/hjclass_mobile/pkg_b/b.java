...
public final class b
{
  ...
  private static List a(Document paramDocument)
  {
    ...
    {
      hjapp.com.hjclass_mobile.pkg_d.z localz = new z();
  ...
  public final void b(r paramr)
  {
    ...
    while (true)
    {
      ...
      try
      {
        ...
        arrayOfObject2[5] = hjapp.com.hjclass_mobile.pkg_h.z.b(paramr.d());
    ...
    try
    {
      ...
      arrayOfObject1[7] = hjapp.com.hjclass_mobile.pkg_h.z.b(paramr.d());
  ...
  {
    if (!hjapp.com.hjclass_mobile.pkg_h.z.j);
    int i;
    do
    {
      return;
  ...
  public final boolean h(int paramInt1, int paramInt2)
  {
    ...
    if ((localCursor != null) && (localCursor.getCount() > 0))
    {
      ...
      hjapp.com.hjclass_mobile.pkg_h.u.b("是否过期", "isExpired=" + i);
      if (i == 1)
        return true;
    }
    return false;
