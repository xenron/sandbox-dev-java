...
public class IndexFileTask extends RecursiveTask<List<FileEntity2>>{ 
	...
	@Resource
	private FileEntity2Service fileService2;
    ...
    {
    	fileService2.truncate();
    	fileService2.saveAll(result);
    }
    ...
    public static void main(String[]args) throws InterruptedException, ExecutionException{
    	 IndexFileTask task = (IndexFileTask) SpringUtils.getBean("fileIndexTask");	
