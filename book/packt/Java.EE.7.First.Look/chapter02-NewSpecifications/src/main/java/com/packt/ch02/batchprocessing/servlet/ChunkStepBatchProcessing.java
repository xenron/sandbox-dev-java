 ...
 */
@WebServlet(name = "ChunkStepBatchProcessing", urlPatterns = {"/ChunkStepBatchProcessing"})
public class ChunkStepBatchProcessing extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>SERVLET CHUNK PROCESSING</title>");
            out.println("</head>");
            out.println("<body>");
            
            out.println("<h1>ChunkStepBatchProcessing - Job information</h1>");
            ...
            if (jobOperator != null) {
                jobID = jobOperator.start("inscriptionJob", props);
            }
