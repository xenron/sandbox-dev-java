...
import com.packt.ch04.entities.listeners.LogEntityListener;
...
@NamedQueries({
    ...
    @NamedQuery(name = "Student.findByDepartid", query = "SELECT s FROM Student s WHERE s.departid = :departid")})
