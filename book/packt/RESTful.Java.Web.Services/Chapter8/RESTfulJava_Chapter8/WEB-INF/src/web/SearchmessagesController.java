...
public class SearchmessagesController implements ModelDriven<Object>, ServletRequestAware {
	private String id;
	private String representation;
	private HttpServletRequest request;

	// GET /searchmessages/{search_item}
	public HttpHeaders show() {
		String acceptHeader = request.getHeader("Accept");
		String type = "xml";
		if (acceptHeader == null || acceptHeader.isEmpty() || acceptHeader.equals("application/xml")) {
			representation = MessageBO.searchAllXML(id);
		} else if (acceptHeader.equals("application/json")) {
			representation = MessageBO.searchAllJSON(id);
			type = "json";
		}
