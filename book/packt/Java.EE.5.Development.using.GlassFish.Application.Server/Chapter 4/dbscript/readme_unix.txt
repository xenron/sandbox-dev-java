...
3. Change directory to [glassfish installation directory]/glassfish/javadb/frameworks/NetworkServer/bin.
4. Open the file called setNetworkClientCP.ksh in your favorite text editor.
...
7. From the command line and still in the directory from step 3, run the
following command:
   source setNetworkClientCP.ksh
