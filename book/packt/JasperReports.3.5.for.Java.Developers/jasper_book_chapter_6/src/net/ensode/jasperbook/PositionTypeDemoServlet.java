...
public class PositionTypeDemoServlet extends HttpServlet
{
      ...
      throws ServletException, IOException
  {
    ...
    //Modify the next line and redeploy to see the other demos.
    //use "/reports/FixRelativeToTopDemo.jasper", 
    //"/reports/FixRelativeToBottomDemo.jasper",
    //or "/reports/FloatDemo.jasper" as a appropriate.
    InputStream reportStream = getServletConfig().getServletContext()
        .getResourceAsStream("/reports/RelativeToTallestObjectDemo.jasper");
