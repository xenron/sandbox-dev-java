...
public class GsonJsonStreamingWriterExample {
    ...
    /**
     * This method reads JSON representation of objects from  sourceFile
     * and copies the contents in to destinationFile using streaming APIs
     * @throws IOException 
     */
    ...
    private void writeJSONObject(JsonWriter writer, Employee employee) throws IOException {
        /**
         * Then call beginObject() to start encoding a new
         * employee object. This is followed by encoding of name and value.
         * To finish encoding of current object, call endObject() 
         * and to finish encoding of current array.
         */
        writer.beginObject();
