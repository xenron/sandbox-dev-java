...
public class JacksonJsonStreamingParserExample {
    ...
    /**
     * This method demonstrates the use of Jackson streaming reader API. 
     * It reads the contents from input file and builds List<Employee>
     * 
     * @param jsonFileName
     * @return
     * @throws IOException 
    ...
    public List<Employee> buildEmployeeList(String jsonFileName) throws IOException {
        ...
        try {
            ...
            inpustStream = getClass().getResourceAsStream(jsonFileName);
            //Creates Streamin parser
            jsonParser = new JsonFactory().createParser(inpustStream);
