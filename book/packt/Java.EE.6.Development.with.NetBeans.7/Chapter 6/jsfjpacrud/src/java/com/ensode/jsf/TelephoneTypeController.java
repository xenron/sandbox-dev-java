...
import com.ensode.jsf.util.PaginationHelper;
...
@ManagedBean (name="telephoneTypeController")
@SessionScoped
public class TelephoneTypeController implements Serializable {
    ...
    @EJB private com.ensode.jpacontroller.TelephoneTypeFacade ejbFacade;
    ...
    public static class TelephoneTypeControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof TelephoneType) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: "+TelephoneTypeController.class.getName());
            }
        }
