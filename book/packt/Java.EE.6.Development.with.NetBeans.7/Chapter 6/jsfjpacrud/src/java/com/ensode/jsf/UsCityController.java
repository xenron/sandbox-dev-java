...
@ManagedBean (name="usCityController")
@SessionScoped
public class UsCityController implements Serializable {
    ...
    @EJB private com.ensode.jpacontroller.UsCityFacade ejbFacade;
    ...
    public static class UsCityControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof UsCity) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: "+UsCityController.class.getName());
            }
        }
