...
public class AppUserController implements Serializable {
    ...
    @EJB private com.ensode.jpacontroller.AppUserFacade ejbFacade;
    ...
    public static class AppUserControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof AppUser) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: "+AppUserController.class.getName());
            }
        }
