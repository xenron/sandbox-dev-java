...
@ManagedBean (name="userRoleController")
@SessionScoped
public class UserRoleController implements Serializable {
    ...
    @EJB private com.ensode.jpacontroller.UserRoleFacade ejbFacade;
    ...
    public static class UserRoleControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof UserRole) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: "+UserRoleController.class.getName());
            }
        }
