...
@ManagedBean (name="usStateController")
@SessionScoped
public class UsStateController implements Serializable {
    ...
    @EJB private com.ensode.jpacontroller.UsStateFacade ejbFacade;
    ...
    public static class UsStateControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof UsState) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: "+UsStateController.class.getName());
            }
        }
